    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={styles.header}>
        ...
        <Button
          ...
          size="sm"
          onPress={() => router.push({ pathname: '/(admin)/create-homework', params: { batchId, batchName } })}
        />
      </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PressableCard
            style={styles.row}
            onPress={() => router.push({ pathname: '/(admin)/homework-detail', params: { id: item._id, title: item.title } })}
          >
            <View style={{ flex: 1 }}>
