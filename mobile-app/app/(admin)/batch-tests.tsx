    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={styles.header}>
        ...
        <Button
          label="+ Create Test"
          size="sm"
          onPress={() => router.push({ pathname: '/(admin)/create-test', params: { batchId, batchName } })}
        />
      </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PressableCard style={styles.row} onPress={() => router.push({ pathname: '/(admin)/test-detail', params: { id: item._id } })}>
            <View style={{ flex: 1 }}>
