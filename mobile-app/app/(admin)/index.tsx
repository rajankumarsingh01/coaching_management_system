...
//       <TouchableOpacity
//   style={[styles.createButton, { backgroundColor: '#7c3aed', marginBottom: 20 }]}
//   onPress={() => router.push('/(admin)/poster-generator')}
// >
//   <Text style={styles.createButtonText}>🎨 Poster Generator</Text>
// </TouchableOpacity>
