...
export default function TeacherCalendarEventsScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={styles.header}>
        <Text style={[typography.caption, { color: colors.textMuted }]}>Your batch events & institute-wide events</Text>
        <Button label="+ Add Event" size="sm" onPress={() => router.push('/(teacher)/create-event')} />
      </View>
